...
import com.wastely.dao.BarangayDao;
...
public class BarangayService {
    ...
    public String getAdminNameByBarangay(Barangay barangayName) {
        if (barangayName == null) {
            return null;
        }

        return barangayDao.findAdminByBarangayName(barangayName);
    }

    public String getAdminNameByBarangayId(int barangayId) {
        return barangayDao.findAdminByBarangayId(barangayId);
    }
