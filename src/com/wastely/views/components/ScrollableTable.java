...
public final class ScrollableTable extends JPanel {
    ...
    public ScrollableTable(String... columnNames) {
        ...
        scrollPane = new CustomScrollPane(table);
    ...
    public ScrollableTable setTitle(String title) {
        this.title = title;
    ...
    private void configureHeader() {
        ...
        header.setFont(Typography.TABLE_HEADER);
        header.setReorderingAllowed(false);
        header.setResizingAllowed(true);
        header.setBackground(Colors.SECONDARY_LIGHT_GREEN);
        ...
        header.setDefaultRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(
                ...
                label.setFont(Typography.TABLE_HEADER);
                label.setOpaque(true);
                label.setBackground(Colors.SECONDARY_LIGHT_GREEN);
    ...
    private void configureCells() {
        DefaultTableCellRenderer renderer = new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(
                ...
                JLabel label = new JLabel(value == null ? "" : value.toString());
                label.setFont(Typography.TABLE_CELL);
                label.setOpaque(true);
                label.setVerticalAlignment(SwingConstants.CENTER);
                ...
                * Heuristic rules:
                * - Long / free text -> LEFT
                * - Structured / short / numeric -> CENTER
                */
                boolean isLongText =
                        valueStr.length() > 12 ||
                        columnName.equalsIgnoreCase("Barangay") ||
                        columnName.equalsIgnoreCase("Admin") ||
                        columnName.equalsIgnoreCase("Name") ||
                        columnName.equalsIgnoreCase("Address") ||
                        columnName.equalsIgnoreCase("Description");

                boolean isNumericOrCode =
                        valueStr.matches("\\d+") ||
                        columnName.equalsIgnoreCase("Contact") ||
                        columnName.equalsIgnoreCase("ID") ||
                        columnName.equalsIgnoreCase("Status") ||
                        columnName.equalsIgnoreCase("Priority") ||
                        columnName.equalsIgnoreCase("Date");

                if (isLongText) {
                    label.setHorizontalAlignment(SwingConstants.LEFT);
                } else if (isNumericOrCode) {
                    label.setHorizontalAlignment(SwingConstants.CENTER);
                } else {
                    label.setHorizontalAlignment(SwingConstants.CENTER);
                }
                ...
                if (isSelected) {
                    ...
                    label.setBackground(Colors.BACKGROUND_GRAY);
                } else {
                    label.setBackground(Colors.BACKGROUND_WHITE);
                }
    ...
    private static class ActionCellRenderer implements TableCellRenderer {
        ...
        public ActionCellRenderer() {
            button = new JButton();
            button.setIcon(Loader.loadIcon("ellipsis.png", 20));
        ...
        public Component getTableCellRendererComponent(
            ...
            if (isSelected) {
                button.setBackground(Colors.SECONDARY_LIGHT_GREEN);
            } else if (row % 2 == 0) {
                button.setBackground(Colors.BACKGROUND_GRAY);
            } else {
                button.setBackground(Colors.BACKGROUND_WHITE);
            }
